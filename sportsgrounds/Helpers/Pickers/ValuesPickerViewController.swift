//
//  ValuesPickerViewController.swift
//  sportsgrounds
//
...
extension UIAlertController {
    ...
    func addPickerView(values: ValuesPickerViewController.Values,  initialSelection: ValuesPickerViewController.Index? = nil, action: ValuesPickerViewController.Action?) {
        let pickerView = ValuesPickerViewController(values: values, initialSelection: initialSelection, action: action)
        set(vc: pickerView, height: 216)
    }
}

final class ValuesPickerViewController: UIViewController {
...
extension ValuesPickerViewController: UIPickerViewDataSource, UIPickerViewDelegate {
