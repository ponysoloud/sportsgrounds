    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        ...
        case .participantsDetails:
            ...
            if textField == self.participantsAgeTextField {
                ...
                alert.addRangePicker(minimumValue: 3, maximumValue: 70) { (lower, upper) in
        ...
        case .dateDetails:
            if textField == self.dateTextField {
                ...
                alert.addDatePicker(mode: .dateAndTime, date: Date(), minimumDate: Date(), maximumDate: Date().adding(days: 7)) { date in
